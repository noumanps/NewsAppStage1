    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < resultsArray.length(); i++) {
                ...
                String newsTitle = resultJSON.getString("webTitle");
                String newsSection = resultJSON.getString("sectionName");
                String newsDate = resultJSON.getString("webPublicationDate");
                String newsUrl = resultJSON.getString("webUrl");
                ...
                News news = new News(newsTitle, author, newsSection, newsDate, newsUrl);
                newsList.add(news);
            }
