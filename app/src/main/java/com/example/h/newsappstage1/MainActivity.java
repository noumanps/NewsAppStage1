...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<News>>{
    ...
    private static String mRequestUrl =
            "https://content.guardianapis.com/search?q=format=json&show-tags=contributor&api-key=2b49886d-e817-4bb9-98cb-72de9afb7d52";

    //ListView For News List
    ...
    //boolean variable to check internet connectivity
    Boolean isConnected;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //returns true or false based on internet connectivity
